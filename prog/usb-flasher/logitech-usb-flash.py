...
response = dongle.send_command(0x21, 0x09, 0x0200, 0x0000, b"\x80" + bytearray(31))
...
response = dongle.send_command(0x21, 0x09, 0x0200, 0x0000, b"\x20\x00\x00\x01\x02" + bytearray(27))
